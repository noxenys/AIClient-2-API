...
const translations = {
    'zh-CN': {
        ...
        'dashboard.update.redeploy': '重新部署',
        'dashboard.update.redeployTitle': '镜像部署模式下，请重新部署服务以应用新版本',
        'dashboard.update.rollback': '回滚上一版',
        'dashboard.update.rollbackTitle': '回滚到当前版本的上一可用标签',
        ...
        'dashboard.update.redeployConfirmMsg': '当前为镜像部署模式。确定要按版本 {version} 进行重新部署提示吗？',
        'dashboard.update.redeployHint': '当前为镜像部署模式，请重新部署服务以应用版本 {version}',
        'dashboard.update.rollbackConfirmMsg': '确定要回滚到版本 {version} 吗？服务可能会短暂不可用。',
        'dashboard.update.rollbackRedeployConfirmMsg': '当前为镜像部署模式。请重新部署到回滚版本 {version}。',
        'dashboard.update.noRollbackTarget': '当前版本没有可用的上一版标签',
        'dashboard.update.mode': '更新模式',
        'dashboard.update.mode.image': '镜像部署',
        'dashboard.update.mode.git': 'Git 仓库',
        'dashboard.update.mode.tarball': '压缩包更新',
        'dashboard.update.mode.auto': '自动判定',
        'dashboard.update.mode.unknown': '未知模式',
        'dashboard.update.modeHint.image': '当前为镜像部署模式。Web UI 会在当前容器内下载并替换到选中的版本，完成后建议立即重启；如果实例被平台重新创建，最终仍以镜像本身的版本为准。',
        'dashboard.update.modeHint.git': '当前为 Git 仓库模式。可直接切换到选中的标签版本，并在需要时执行依赖更新。',
        'dashboard.update.modeHint.tarball': '当前为压缩包更新模式。服务会下载并覆盖到选中的版本，完成后建议立即重启。',
        'dashboard.update.modeHint.auto': '当前为自动判定模式，实际执行方式取决于运行环境。',
        'dashboard.update.modeHint.unknown': '当前运行环境未识别，建议优先使用手动部署方式更新。',
        'dashboard.update.repo': '更新源',
        'dashboard.update.release': '最新发布',
        'dashboard.update.publishedAt': '发布时间',
        'dashboard.update.notes': '发布说明',
        'dashboard.update.notesEmpty': '该版本未提供发布说明',
        'dashboard.update.openRelease': '查看发布页',
        ...
        'providers.cooldown.summary': '429 冷却 {count}',
        'providers.cooldown.nextRecovery': '最早恢复',
        ...
        'modelStatus.page.title': '模型状态监控',
        'modelStatus.page.refresh': '刷新监控',
        'modelStatus.page.description': '按提供商维度查看最近 24 小时模型运行状态，不再混在账号池管理弹窗里。',
        'modelStatus.page.providerSearchPlaceholder': '搜索提供商名称、ID 或分组...',
        'modelStatus.page.loadingProviders': '正在加载提供商监控视图...',
        'modelStatus.page.loadingStatus': '正在加载模型状态...',
        'modelStatus.page.loadStatusFailed': '模型状态加载失败',
        'modelStatus.page.emptyProviders': '当前没有可监控的提供商',
        'modelStatus.page.noProviderMatched': '没有匹配的提供商',
        'modelStatus.page.card.nodes': '节点',
        'modelStatus.page.card.models': '模型',
        'modelStatus.page.card.noData': '暂无数据',
        ...
        'modal.provider.catalog.title': '模型目录',
        'modal.provider.catalog.modelCount': '目录模型数',
        'modal.provider.catalog.activeModelCount': '本次探测到',
        'modal.provider.catalog.pendingRemovalCount': '待确认下架',
        'modal.provider.catalog.removedModelCount': '已确认下架',
        'modal.provider.catalog.missingThreshold': '连续缺失阈值',
        'modal.provider.catalog.sampledNodes': '采样节点',
        'modal.provider.catalog.source': '目录来源',
        'modal.provider.catalog.lastReason': '最近原因',
        'modal.provider.catalog.lastRefresh': '上次刷新',
        'modal.provider.catalog.lastSuccessRefresh': '最近成功刷新',
        'modal.provider.catalog.nextExpire': '过期时间',
        'modal.provider.catalog.cacheUpdated': '缓存更新时间',
        'modal.provider.catalog.filePath': '缓存文件',
        'modal.provider.catalog.error': '最近错误',
        'modal.provider.catalog.addedModels': '最近新增模型',
        'modal.provider.catalog.removedModels': '最近移除模型',
        'modal.provider.catalog.noAddedModels': '最近没有新增模型',
        'modal.provider.catalog.noRemovedModels': '最近没有移除模型',
        'modal.provider.catalog.empty': '该 provider 还没有目录缓存，可直接点击“刷新目录”建立。',
        'modal.provider.catalog.fetchFailed': '目录状态加载失败',
        'modal.provider.catalog.refresh': '刷新目录',
        'modal.provider.catalog.refreshing': '正在刷新目录...',
        'modal.provider.catalog.retry': '失败重探',
        'modal.provider.catalog.retrying': '正在重探失败目录...',
        'modal.provider.catalog.retryNotNeeded': '当前目录状态正常，无需失败重探',
        'modal.provider.catalog.refresh.success': '{type} 模型目录已刷新',
        'modal.provider.catalog.refresh.failed': '刷新模型目录失败',
        'modal.provider.catalog.retry.success': '{type} 失败目录已重探',
        'modal.provider.catalog.retry.failed': '失败目录重探失败',
        'modal.provider.catalog.status.ready': '已就绪',
        'modal.provider.catalog.status.stale': '缓存过期',
        'modal.provider.catalog.status.fallback': '回退种子',
        'modal.provider.catalog.status.unknown': '未建立',
        'modal.provider.catalog.status.loading': '加载中',
        'modal.provider.catalog.source.native_api': '原生接口',
        'modal.provider.catalog.source.plan_inference': 'Plan 推断',
        'modal.provider.catalog.source.grok_modes': 'Grok 模式探测',
        'modal.provider.catalog.source.fallback_seed': '种子回退',
        'modal.provider.catalog.source.multi_probe': '多节点合并',
        'modal.provider.catalog.source.error': '错误',
        'modal.provider.modelStatus.title': '模型状态监控',
        'modal.provider.modelStatus.subtitle': '最近 {hours} 小时模型运行状态一览，监测所有请求（包括格式错误）',
        'modal.provider.modelStatus.updatedAt': '缓存更新时间',
        'modal.provider.modelStatus.totalModels': '模型总数',
        'modal.provider.modelStatus.monitoredModels': '监控模型数',
        'modal.provider.modelStatus.healthyCount': '健康',
        'modal.provider.modelStatus.degradedCount': '降级',
        'modal.provider.modelStatus.failingCount': '失败',
        'modal.provider.modelStatus.unknownCount': '未知',
        'modal.provider.modelStatus.successRate': '成功率',
        'modal.provider.modelStatus.successRateHint': '过去 {hours} 小时',
        'modal.provider.modelStatus.totalTokens': 'Token总数',
        'modal.provider.modelStatus.totalTokensHint': '过去 {hours} 小时',
        'modal.provider.modelStatus.totalRequests': '请求总数',
        'modal.provider.modelStatus.totalRequestsHint': '过去 {hours} 小时',
        'modal.provider.modelStatus.highQualityModels': '优良模型',
        'modal.provider.modelStatus.highQualityHint': '成功率 >= 80%',
        'modal.provider.modelStatus.activeModelsHint': '个活跃模型',
        'modal.provider.modelStatus.legend': '状态图例',
        'modal.provider.modelStatus.searchPlaceholder': '搜索模型...',
        'modal.provider.modelStatus.noSearchResults': '没有匹配的模型',
        'modal.provider.modelStatus.streamInterrupted': '流中断',
        'modal.provider.modelStatus.fetchFailed': '模型状态加载失败',
        'modal.provider.modelStatus.loading': '正在加载模型状态...',
        'modal.provider.modelStatus.empty': '当前还没有模型运行数据，发起请求后这里会实时显示。',
        'modal.provider.modelStatus.status.healthy': '健康',
        'modal.provider.modelStatus.status.degraded': '降级',
        'modal.provider.modelStatus.status.failing': '失败',
        'modal.provider.modelStatus.status.unknown': '未知',
        'modal.provider.modelStatus.metric.successRate': '成功率',
        'modal.provider.modelStatus.metric.nodes': '节点',
        'modal.provider.modelStatus.metric.streamInterrupted': '流中断',
        'modal.provider.modelStatus.metric.latency': '延迟',
        'modal.provider.modelStatus.metric.requests': '请求数',
        'modal.provider.modelStatus.metric.requestsShort': '请求',
        'modal.provider.modelStatus.metric.totalTokens': 'Token',
        'modal.provider.modelStatus.metric.totalTokensShort': 'Token',
        'modal.provider.modelStatus.metric.lastFailure': '最近故障',
        'modal.provider.modelStatus.metric.lastFailureAt': '故障时间',
        'modal.provider.modelStatus.bucket.time': '时间',
        'modal.provider.modelStatus.bucket.grade': '状态',
        'modal.provider.modelStatus.grade.excellent': '优秀 (>95%)',
        'modal.provider.modelStatus.grade.good': '良好 (80-95%)',
        'modal.provider.modelStatus.grade.fair': '一般 (60-80%)',
        'modal.provider.modelStatus.grade.poor': '欠佳 (20-60%)',
        'modal.provider.modelStatus.grade.error': '异常 (<20%)',
        'modal.provider.modelStatus.grade.no_data': '无请求',
        ...
        'modal.provider.runtimeReason': '状态原因',
        'modal.provider.cooldownUntil': '冷却至',
        'modal.provider.runtimeState.healthy': '正常',
        'modal.provider.runtimeState.cooldown': '冷却中',
        'modal.provider.runtimeState.risky': '风险',
        'modal.provider.runtimeState.banned': '失效',
        'modal.provider.runtimeState.disabled': '禁用',
        ...
        'modal.provider.deleteUnhealthy': '删除失效节点',
        'modal.provider.deleteUnhealthyBtn': '删除失效',
        'modal.provider.deleteUnhealthyConfirm': '确定要处理 {count} 个异常节点吗？\n\n仅删除明确失效的 401/403 或需重新认证节点，429 会保留。此操作不可恢复。',
        'modal.provider.deleteUnhealthy.noUnhealthy': '没有异常节点',
        'modal.provider.deleteUnhealthy.deleting': '正在删除失效节点...',
        'modal.provider.deleteUnhealthy.success': '已删除 {count} 个失效节点，保留 {skipped} 个非永久异常节点',
        'modal.provider.deleteUnhealthy.noInvalid': '没有可删除的失效节点，已保留 {skipped} 个 429/临时异常节点',
        ...
        'usage.card.status.cooldown': '冷却中',
        'usage.card.status.risky': '风险',
        'usage.card.status.banned': '失效',
        ...
        'models.status.healthy': '健康',
        'models.status.degraded': '降级',
        'models.status.failing': '失败',
        'models.status.unknown': '未知',
        'models.metric.successRate': '成功率',
        'models.metric.selectableNodes': '可选节点',
        'models.metric.streamInterrupted': '流中断',
        'models.metric.avgLatency': '延迟',
    ...
    'en-US': {
        ...
        'dashboard.update.redeploy': 'Redeploy',
        'dashboard.update.redeployTitle': 'Redeploy the service to apply the new image version',
        'dashboard.update.rollback': 'Rollback',
        'dashboard.update.rollbackTitle': 'Roll back to the previous available tag',
        ...
        'dashboard.update.redeployConfirmMsg': 'Image deployment mode detected. Show redeploy guidance for version {version}?',
        'dashboard.update.redeployHint': 'Image deployment mode detected. Please redeploy the service to apply version {version}',
        'dashboard.update.rollbackConfirmMsg': 'Are you sure you want to roll back to version {version}? Service may be briefly unavailable.',
        'dashboard.update.rollbackRedeployConfirmMsg': 'Image deployment mode detected. Please redeploy the service to rollback image version {version}.',
        'dashboard.update.noRollbackTarget': 'No previous rollback tag is available for the current version',
        'dashboard.update.mode': 'Update Mode',
        'dashboard.update.mode.image': 'Image Deployment',
        'dashboard.update.mode.git': 'Git Repository',
        'dashboard.update.mode.tarball': 'Tarball Update',
        'dashboard.update.mode.auto': 'Auto Detect',
        'dashboard.update.mode.unknown': 'Unknown Mode',
        'dashboard.update.modeHint.image': 'Image deployment mode will download and replace the selected version inside the current container. A restart is recommended after completion. If the platform recreates the instance, the image-bundled version still becomes the final source of truth.',
        'dashboard.update.modeHint.git': 'Git repository mode can switch directly to the selected tag and update dependencies when needed.',
        'dashboard.update.modeHint.tarball': 'Tarball mode downloads and replaces the codebase with the selected version. Restart is recommended immediately after completion.',
        'dashboard.update.modeHint.auto': 'Auto mode chooses the actual update behavior from the current runtime environment.',
        'dashboard.update.modeHint.unknown': 'The runtime environment could not be identified. Prefer manual deployment for updates.',
        'dashboard.update.repo': 'Update Source',
        'dashboard.update.release': 'Latest Release',
        'dashboard.update.publishedAt': 'Published At',
        'dashboard.update.notes': 'Release Notes',
        'dashboard.update.notesEmpty': 'No release notes were provided for this version',
        'dashboard.update.openRelease': 'Open Release Page',
        ...
        'providers.cooldown.summary': '429 cooldown {count}',
        'providers.cooldown.nextRecovery': 'Next recovery',
        ...
        'modelStatus.page.title': 'Model Status',
        'modelStatus.page.refresh': 'Refresh',
        'modelStatus.page.description': 'View the last 24 hours of model runtime by provider, separate from the provider pool modal.',
        'modelStatus.page.providerSearchPlaceholder': 'Search provider name, id, or group...',
        'modelStatus.page.loadingProviders': 'Loading provider monitoring view...',
        'modelStatus.page.loadingStatus': 'Loading model status...',
        'modelStatus.page.loadStatusFailed': 'Failed to load model status',
        'modelStatus.page.emptyProviders': 'No providers available for monitoring',
        'modelStatus.page.noProviderMatched': 'No matching providers',
        'modelStatus.page.card.nodes': 'Nodes',
        'modelStatus.page.card.models': 'models',
        'modelStatus.page.card.noData': 'No data',
        ...
        'modal.provider.catalog.title': 'Model Catalog',
        'modal.provider.catalog.modelCount': 'Catalog models',
        'modal.provider.catalog.activeModelCount': 'Detected now',
        'modal.provider.catalog.pendingRemovalCount': 'Pending removal',
        'modal.provider.catalog.removedModelCount': 'Removed',
        'modal.provider.catalog.missingThreshold': 'Missing threshold',
        'modal.provider.catalog.sampledNodes': 'Sampled nodes',
        'modal.provider.catalog.source': 'Catalog source',
        'modal.provider.catalog.lastReason': 'Latest reason',
        'modal.provider.catalog.lastRefresh': 'Last refresh',
        'modal.provider.catalog.lastSuccessRefresh': 'Last successful refresh',
        'modal.provider.catalog.nextExpire': 'Expires at',
        'modal.provider.catalog.cacheUpdated': 'Cache updated',
        'modal.provider.catalog.filePath': 'Cache file',
        'modal.provider.catalog.error': 'Latest error',
        'modal.provider.catalog.addedModels': 'Recently added models',
        'modal.provider.catalog.removedModels': 'Recently removed models',
        'modal.provider.catalog.noAddedModels': 'No models were added recently',
        'modal.provider.catalog.noRemovedModels': 'No models were removed recently',
        'modal.provider.catalog.empty': 'No catalog cache for this provider yet. Click "Refresh Catalog" to build one.',
        'modal.provider.catalog.fetchFailed': 'Failed to load catalog state',
        'modal.provider.catalog.refresh': 'Refresh Catalog',
        'modal.provider.catalog.refreshing': 'Refreshing catalog...',
        'modal.provider.catalog.retry': 'Retry Failed',
        'modal.provider.catalog.retrying': 'Retrying failed catalog...',
        'modal.provider.catalog.retryNotNeeded': 'Catalog is healthy. No retry needed.',
        'modal.provider.catalog.refresh.success': '{type} catalog refreshed',
        'modal.provider.catalog.refresh.failed': 'Failed to refresh catalog',
        'modal.provider.catalog.retry.success': '{type} failed catalog retried',
        'modal.provider.catalog.retry.failed': 'Failed catalog retry failed',
        'modal.provider.catalog.status.ready': 'Ready',
        'modal.provider.catalog.status.stale': 'Stale cache',
        'modal.provider.catalog.status.fallback': 'Fallback seed',
        'modal.provider.catalog.status.unknown': 'Not built',
        'modal.provider.catalog.status.loading': 'Loading',
        'modal.provider.catalog.source.native_api': 'Native API',
        'modal.provider.catalog.source.plan_inference': 'Plan inference',
        'modal.provider.catalog.source.grok_modes': 'Grok modes',
        'modal.provider.catalog.source.fallback_seed': 'Seed fallback',
        'modal.provider.catalog.source.multi_probe': 'Multi probe',
        'modal.provider.catalog.source.error': 'Error',
        'modal.provider.modelStatus.title': 'Model Status',
        'modal.provider.modelStatus.subtitle': 'Last {hours}h runtime timeline for all requests, including malformed failures.',
        'modal.provider.modelStatus.updatedAt': 'Updated',
        'modal.provider.modelStatus.totalModels': 'Models',
        'modal.provider.modelStatus.monitoredModels': 'Monitored models',
        'modal.provider.modelStatus.healthyCount': 'Healthy',
        'modal.provider.modelStatus.degradedCount': 'Degraded',
        'modal.provider.modelStatus.failingCount': 'Failing',
        'modal.provider.modelStatus.unknownCount': 'Unknown',
        'modal.provider.modelStatus.successRate': 'Success rate',
        'modal.provider.modelStatus.successRateHint': 'Last {hours}h',
        'modal.provider.modelStatus.totalTokens': 'Total tokens',
        'modal.provider.modelStatus.totalTokensHint': 'Last {hours}h',
        'modal.provider.modelStatus.totalRequests': 'Total requests',
        'modal.provider.modelStatus.totalRequestsHint': 'Last {hours}h',
        'modal.provider.modelStatus.highQualityModels': 'Healthy models',
        'modal.provider.modelStatus.highQualityHint': 'Success >= 80%',
        'modal.provider.modelStatus.activeModelsHint': 'active models',
        'modal.provider.modelStatus.legend': 'Legend',
        'modal.provider.modelStatus.searchPlaceholder': 'Search model...',
        'modal.provider.modelStatus.noSearchResults': 'No matching models',
        'modal.provider.modelStatus.streamInterrupted': 'Stream interrupted',
        'modal.provider.modelStatus.fetchFailed': 'Failed to load model status',
        'modal.provider.modelStatus.loading': 'Loading model status...',
        'modal.provider.modelStatus.empty': 'No model runtime data yet. It will appear after requests hit this provider.',
        'modal.provider.modelStatus.status.healthy': 'Healthy',
        'modal.provider.modelStatus.status.degraded': 'Degraded',
        'modal.provider.modelStatus.status.failing': 'Failing',
        'modal.provider.modelStatus.status.unknown': 'Unknown',
        'modal.provider.modelStatus.metric.successRate': 'Success',
        'modal.provider.modelStatus.metric.nodes': 'Nodes',
        'modal.provider.modelStatus.metric.streamInterrupted': 'Interrupted',
        'modal.provider.modelStatus.metric.latency': 'Latency',
        'modal.provider.modelStatus.metric.requests': 'Requests',
        'modal.provider.modelStatus.metric.requestsShort': 'Req',
        'modal.provider.modelStatus.metric.totalTokens': 'Tokens',
        'modal.provider.modelStatus.metric.totalTokensShort': 'Tokens',
        'modal.provider.modelStatus.metric.lastFailure': 'Last failure',
        'modal.provider.modelStatus.metric.lastFailureAt': 'Failed at',
        'modal.provider.modelStatus.bucket.time': 'Window',
        'modal.provider.modelStatus.bucket.grade': 'Grade',
        'modal.provider.modelStatus.grade.excellent': 'Excellent (>95%)',
        'modal.provider.modelStatus.grade.good': 'Good (80-95%)',
        'modal.provider.modelStatus.grade.fair': 'Fair (60-80%)',
        'modal.provider.modelStatus.grade.poor': 'Poor (20-60%)',
        'modal.provider.modelStatus.grade.error': 'Error (<20%)',
        'modal.provider.modelStatus.grade.no_data': 'No data',
        ...
        'modal.provider.runtimeReason': 'State reason',
        'modal.provider.cooldownUntil': 'Cooldown until',
        'modal.provider.runtimeState.healthy': 'Healthy',
        'modal.provider.runtimeState.cooldown': 'Cooldown',
        'modal.provider.runtimeState.risky': 'Risky',
        'modal.provider.runtimeState.banned': 'Banned',
        'modal.provider.runtimeState.disabled': 'Disabled',
        ...
        'modal.provider.deleteUnhealthy': 'Delete invalid nodes',
        'modal.provider.deleteUnhealthyBtn': 'Delete Invalid',
        'modal.provider.deleteUnhealthyConfirm': 'Process {count} abnormal node(s)?\n\nOnly definitive 401/403 or re-authentication failures will be deleted. 429 nodes will be kept. This cannot be undone.',
        'modal.provider.deleteUnhealthy.noUnhealthy': 'No abnormal nodes',
        'modal.provider.deleteUnhealthy.deleting': 'Deleting invalid nodes...',
        'modal.provider.deleteUnhealthy.success': 'Deleted {count} invalid node(s), kept {skipped} non-permanent failures',
        'modal.provider.deleteUnhealthy.noInvalid': 'No deletable invalid nodes. Kept {skipped} 429/temporary failure node(s)',
        ...
        'usage.card.status.cooldown': 'Cooldown',
        'usage.card.status.risky': 'Risky',
        'usage.card.status.banned': 'Banned',
        ...
        'models.status.failing': 'Failing',
        'models.status.unknown': 'Unknown',
        'models.metric.successRate': 'Success',
        'models.metric.selectableNodes': 'Selectable',
        'models.metric.streamInterrupted': 'Interrupted',
        'models.metric.avgLatency': 'Latency',
