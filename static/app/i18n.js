...
const translations = {
    'zh-CN': {
        ...
        'dashboard.update.modeHint.image': '当前为镜像部署模式。Web UI 只提供目标版本提示，实际升级或回滚需要在部署平台重新部署对应镜像标签。',
    ...
    'en-US': {
        ...
        'dashboard.update.modeHint.image': 'Image deployment mode only provides target-version guidance in Web UI. The actual upgrade or rollback must be done by redeploying the matching image tag on your platform.',
